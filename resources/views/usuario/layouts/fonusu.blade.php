...
<nav class="navbar navbar-default">
  <div class="container-fluid"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{ url('/usuario/index')}}">Centro TIC</a></div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="defaultNavbar1">
      <ul class="nav navbar-nav">
        <li><a href="{{ url('/usuario/perfil')}}">Perfil<span class="sr-only">(current)</span></a></li>
        <li><a href="{{ url('/usuario/generarsoli')}}">Generar Solicitud<span class="sr-only">(current)</span></a></li>
        <li><a href="{{ url('/usuario/consultarsoli')}}">Consultar Estado Solicitud<span class="sr-only">(current)</span></a></li>
      </ul>
